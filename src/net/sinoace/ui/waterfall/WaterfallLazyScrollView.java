...
public class WaterfallLazyScrollView extends ScrollView {
	...
	public WaterfallLazyScrollView(Context context) {
		super(context);

	}

	public WaterfallLazyScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);

	}

	public WaterfallLazyScrollView(Context context, AttributeSet attrs, int defStyle) {
