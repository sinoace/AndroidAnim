...
public class WaterfallImageLoaderTask extends AsyncTask<WaterfallFlowTag, Void, Bitmap> {

	private WaterfallFlowTag param;
	private final WeakReference<WaterfallFlowView> imageViewReference;

	public WaterfallImageLoaderTask(WaterfallFlowView imageView) {
		imageViewReference = new WeakReference<WaterfallFlowView>(imageView);
